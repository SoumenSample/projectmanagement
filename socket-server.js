...
httpServer.listen(port, "0.0.0.0", () => {
  logger.logConnection("info", "server", "started", { port, origins: allowedOrigins.length > 0 ? allowedOrigins : "dev:all" });
  // Also output a minimal, non-sensitive console message for local dev convenience
