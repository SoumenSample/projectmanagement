                ...
                <div className="flex justify-end border-b border-border/60 px-3 py-3">
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="h-9 w-[180px] rounded-lg border border-input bg-background px-3 py-2 text-sm outline-none transition-colors focus:border-ring focus:ring-2 focus:ring-ring/20"
                    >
